...
public class WMRouterTransform extends Transform {
     ...
     */
    public static final String J_ROUTER_PATH = "com.hjds.routerlibs".replace('.', '/');
    ...
    public void transform(TransformInvocation invocation) {
        ...
        File dest = invocation.getOutputProvider().getContentLocation(
                "JRouter", TransformManager.CONTENT_CLASS,
    ...
    /**
     * 扫描由注解生成器生成到包 {@link Const#} 里的初始化类
     */
    private void scanDir(File dir, Set<String> initClasses) throws IOException {
        File packageDir = new File(dir, Const.INIT_SERVICE_DIR);
    ...
    private void scanJarFile(File file, Set<String> initClasses) throws IOException {
        ...
        while (entries.hasMoreElements()) {
            ...
            if (name.endsWith(SdkConstants.DOT_CLASS) && name.startsWith(J_ROUTER_PATH)) {
